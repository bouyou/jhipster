package testdata.repository;

import testdata.TestApp;

import testdata.config.Constants;
import testdata.config.audit.AuditEventConverter;
import testdata.domain.PersistentAuditEvent;
...
import static testdata.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
